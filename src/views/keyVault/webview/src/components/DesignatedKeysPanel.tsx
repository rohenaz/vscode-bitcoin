...
export function DesignatedKeysPanel({ keys }: DesignatedKeysPanelProps) {
  ...
  return (
    <div className="grid grid-cols-4 gap-1.5">
      {slots.map(slot => (
        <Card key={slot.label} className="overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              {slot.key && (
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => handleClear(slot.clearCommand, slot.key!.id)}
