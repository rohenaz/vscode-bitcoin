    ...
    <div className="space-y-4">
      ...
      <ItemGroup>
        ...
        <Item variant="outline" size="sm">
          ...
          <ItemActions>
            <Button onClick={() => setAddKeyDialogOpen(true)} size="sm" disabled={vaultState.isLocked}>
              Add
            </Button>
          </ItemActions>
        </Item>
        ...
        <Item variant="outline" size="sm">
          ...
          <ItemActions>
            <Button onClick={handleImportKey} size="sm" variant="secondary" disabled={vaultState.isLocked}>
              Import
            </Button>
          </ItemActions>
        </Item>
      ...
      {/* Dialogs */}
      <ImportKeyDialog open={addKeyDialogOpen} onOpenChange={setAddKeyDialogOpen} />
