  ...
  test('returns formatted result for valid input', async () => {
    ...
    globalThis.fetch = mock(async () => {
      const mockResponse = {
        ...
        url: '',
        json: async () => ({
          transaction: Buffer.from('', 'hex').toString('base64')
        }),
        text: async () => '',
        blob: async () => new Blob(),
